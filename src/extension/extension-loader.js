...
export const loadExtension = function() {
    ...
    PERegister.registerCPEditor('alert-table-title', 'alert-table-title-editor',
        PEFactory.createInputTextEditor('title', 'extension.setting.alertTitle'))
    let typeOptions = [
    ...
    // 显示效果
    PERegister.registerCPEditor('alert-table-effect', 'alert-table-effect-editor',
        PEFactory.createRadioButtonGroupEditor('effect', 'extension.setting.effect', { optionItems: effectOptions }))
    ...
    PERegister.registerEPEditor('alert-table-onClose', 'alert-table-onClose-editor',
            PEFactory.createEventHandlerEditor('onClose', []))
        /* -------------------------------------------------- */
    registerFWGenerator('alert', alertTemplateGenerator) //注册字段组件的代码生成器
        // registerFWGenerator('alert-table', alertTemplateGenerator) //注册字段组件的代码生成器
        /* -------------------------------------------------- */
        /* 字段组件加载完毕 end */
}